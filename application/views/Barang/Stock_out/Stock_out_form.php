              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                 <h5 class ="box-title"> Add Stock Out </h5> 
					...
					<div class="card-body">
						<a href="<?=site_url('stock/out')?>"><button type="submit" class="btn btn-primary">
						...
						<form action="<?=site_url('stock/proses')?>" method="post">
							...
							<div class="form-group">
								<label>Detail</label>
									<input type="text" class="form-control" name="detail" placeholder="rusak/terjual/etc">
							</div>
							
							<div class="form-group">
								<button type="submit" name="out_add" class="btn btn-primary"><i class="fa fa-save"></i> Simpan </button> 
