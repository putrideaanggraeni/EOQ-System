            ...
            <div class="col">
              <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h5 class ="box-title"> Data Stock-Out </h5> <hr>
                </div>
					<div class="card-body">
							...
							<?php $no = 1;
								...
								<tr>
									...
									<td class="text-center">
										...
										<a href="<?=site_url('stock/out/del/'.$data->stock_id.'/'.$data->item_id)?>" id="btn-hapus" class="btn text-white btn-xs" style="background:#87CEEB!important">
